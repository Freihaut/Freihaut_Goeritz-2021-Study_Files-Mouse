...
from Material_to_publish.Data_aggregation_code import Mouse_Data_Procedures as mouse
...
# get the raw dataset
with open(targetDir + "/Raw_Data_Experiment.json") as jsonData:
...
final_df.to_csv(r"name_of_dataset" + datetime.date.today().isoformat() + ".csv", sep='\t', encoding='utf-8')