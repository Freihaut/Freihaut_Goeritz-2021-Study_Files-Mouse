// Self-Assessment-Manikin Component
        ...
        return(
            <div className="section">
                <div className="content">
                    ...
                    <div>
                        <p style={questionTextStyle}>Bitte klicken Sie auf das Bild, das Ihrem aktuellen Befinden am ehesten entspricht</p>
                        <div className="row" style={{display: "flex", paddingLeft: "0%", paddingRight: "5%"}}>
