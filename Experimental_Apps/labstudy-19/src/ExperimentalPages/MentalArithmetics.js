...
import MentalArithmeticAnswers from '../LayoutComponents/MentalArithmeticsAnswers';
...
export default class MentalArithmetic extends Component {
    ...
    constructor(props) {
        ...
        this.tasks = mentalArithmeticTasks[this.props.condition].slice(this.props.taskNumber, this.props.taskNumber + 5);
    }
    ...
    startMAT() {
        ...
        if (this.state.taskCount < this.tasks.length) {
            ...
            this.props.updateScore(this.state.score, this.props.condition, this.props.taskNumber + 5);
    ...
    tick() {
        ...
        if (this.props.condition === "highStress") {
            this.ticker.play();
        }
                ...
                <div className="modal-content">
                    ...
                    <section className="modal-card-body">
                        <div className="content">
                            <h3>Übungsaufgabe "Gleichung lösen"</h3>
                            <p>
                                In dieser Aufgabe geht es darum, die richtige Lösung der jeweils angezeigten Gleichung
                                anzuklicken.
                            </p>
                            <p>
                                Die Lösung ist immer eine Zahl zwischen 0 und 9. Ihnen werden bei jeder Gleichung
                                alle Zahlen zwischen 0 und 9 als mögliche Lösungen angezeigt.
                            </p>
                            <p> Über der Gleichung sehen Sie Ihre bisher erzielte Punktzahl. Für
                                eine richtige Antwort erhalten Sie einen Punkt, für eine falsche Antwort wird Ihnen
                                ein Punkt abgezogen.
                            </p>
                            <p>
                                Sie haben für jede Gleichung solange Zeit, bis der Zeitbalken abgelaufen ist.
                            </p>
                        </div>
                    </section>
    ...
    render() {
        return (
            <div className="section">
                <div style={{height: "550px", width: "800px", border: "solid 3px black"}}>
                    <div style={taskContainerStyle}>
                        <div style={scoreStyle}>
                            <h2>Punktzahl: {this.state.score}</h2>
                        </div>
                ...
                {this.props.condition === "practice" ? this.renderModal() : null}
            </div>
        );
    }
}